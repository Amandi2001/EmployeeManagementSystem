    ...
    <div className="sidebar">
      <div>
        ...
        <nav>
          ...
          <Link to="/hr/add-employee-user" className={isActive("/hr/add-employee-user")}>Add Employee & User</Link>
          
          <Link to="/hr/user-list" className={isActive("/hr/user-list")}>User Management</Link>
          <Link to="/hr/manage-leaves" className={isActive("/hr/manage-leaves")}>Leave Requests</Link>
          <Link to="/hr/attendance" className={isActive("/hr/attendance")}>Attendance Corrections</Link>
          <Link to="/hr/salaries/manage" className={isActive("/hr/salaries/manage")}>Salary Management</Link>
          <Link to="/hr/salaries/paygrade-form" className={isActive("/hr/salaries/paygrade-form")}>Paygrade Form</Link>
          <button className="logout-btn" onClick={onLogout} style={{ marginTop: "20px", width: "100%" }}>
            <FaSignOutAlt /> Logout
          </button>
        </nav>
      </div>
