  ...
  return (
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        <div className="brand">⚙️ Panze Admin</div>
        <nav>
          <Link to="/admin/dashboard" className="nav-item">Dashboard</Link>
          <Link to="/admin/add-employee-user" className="nav-item active">Add Employee & User</Link>
          ...
          <Link to="/admin/salaries/generate" className="nav-item active">Generate Salary</Link>
