...
import "../AdminDashboard.css"; // Reuse AdminDashboard styling
    ...
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav>
          ...
          <Link to="/admin/add-employee-user" className="nav-item">
            Add Employee & User
          </Link>
          <Link to="/admin/manage-employees" className="nav-item">
            Manage Employees
          </Link>
          <Link to="/admin/user-list" className="nav-item">
            User Management
          </Link>
          <Link to="/admin/manage-leaves" className="nav-item">
            Leave Requests
          </Link>
          <Link to="/admin/attendance" className="nav-item active">
